...
signed commit `bf0c9f83ac65d9e7d89c9f2521dd2ad6a1360290` and the response-header
...
| `ZASI_NPM_AUDIT_RETRY_DELAY_SECONDS=0 scripts/npm_audit_retry.sh` on 2026-09-04 UTC under Node 22.22.1 | One invocation completed with `0 vulnerabilities` after a transient retry; a repeat invocation exhausted three registry timeouts and returned exit `2`. No offline fallback or vulnerability suppression is used. | Fresh local audit-wrapper behavior; hosted rerun remains required |
