...
| PR #48 hosted checks for exact head `a78015462b7cfec9c41dabfe6539c6071b8865fd` | Actions/JavaScript-TypeScript/Python analysis, Python 3.11/3.12, syntax/type, distribution, Docker image, Docker Build Check, and CodeQL checks passed after the multimodal contract hardening; PR-only GHCR publication was skipped. The PR remains open pending repository review/merge. | Current hosted CI evidence; not release approval |
