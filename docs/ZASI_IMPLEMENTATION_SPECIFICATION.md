...
| PR #29 hosted checks for exact pushed head `fd7d590ed0d80f9bec04d409a79e750886f943f7` | CodeQL actions/JavaScript-TypeScript/Python, Python 3.11/3.12 with the isolated dependency audit, React/TypeScript validation, distribution, Docker image, and Docker build checks passed; PR package publication skipped. This head contains the signed implementation, legacy-boundary, rollback-rehearsal, and evidence-documentation commits. | Hosted CI evidence; not release approval |
