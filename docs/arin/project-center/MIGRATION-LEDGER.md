...
| Bounded tools/MCP | `cvsz/zcoder` | `api-service` / narrow adapter | `approved` | Source pinned at `7153e8b7a48e9d7f9f1976fae2b23f270ac44dab`; `ADR-ARIN-0002` was accepted by merge of PR #129 and the transport-neutral request/response contract was verified at PR #130 exact head. No real ZCoder endpoint or runtime authority is enabled; fake/local transport remains the next bounded slice. |
...
| `ARIN-MIG-0005` | Bounded tools/MCP source assessment | `cvsz/zcoder@7153e8b7a48e9d7f9f1976fae2b23f270ac44dab` | future bounded tool adapter | `ADR-ARIN-0002` accepted | `approved` | Task 6 native ARIN boundary evidence exists through PR #128; ADR acceptance and adapter-contract evidence are recorded through PRs #129-#130 | Disable/remove future adapter; no source copy | Runtime integration remains disabled pending fake/local transport evidence |
