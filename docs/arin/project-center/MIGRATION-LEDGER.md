...
| Bounded tools/MCP | `cvsz/zcoder` | `api-service` / narrow adapter | `candidate` | Source pinned at `7153e8b7a48e9d7f9f1976fae2b23f270ac44dab`; Task 6 security requirements are extracted into `docs/arin/integrations/ZCODER.md`, but public contracts, alternatives/risks, reproducible exact-head containment/MCP CI/security evidence, and the ARIN-owned descriptor/runtime adapter remain incomplete |
...
| `ARIN-MIG-0009` | ARIN bounded tool/MCP security requirements | `cvsz/zcoder@7153e8b7a48e9d7f9f1976fae2b23f270ac44dab` | `docs/arin/integrations/ZCODER.md` | Pending integration ADR before runtime dependency | `integrating` | Documentation slice requires exact-head ZASI workflow evidence | Revert documentation PR; no runtime dependency or authority added | Extracts fail-closed filesystem/network/secret/approval/tenant/resource/subprocess/audit invariants and explicitly denies actuator authority |
