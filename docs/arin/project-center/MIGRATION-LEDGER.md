...
| Bounded tools/MCP | `cvsz/zcoder` | `api-service` / narrow adapter | `candidate` | Source pinned at `7153e8b7a48e9d7f9f1976fae2b23f270ac44dab`; Task 6 security requirements are verified at PR #126 and an ARIN-owned fail-closed capability-descriptor slice is integrating; runtime service integration, full source assessment and ADR remain incomplete |
