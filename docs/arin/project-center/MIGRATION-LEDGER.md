...
| `ARIN-MIG-0015` | ARIN legacy identity/compatibility inventory | `cvsz/zasi@b0f5a5725fbcfaea53fb3e0135b35f5ca483d596`; `cvsz/zworkforce@634599e02f85d42a63535eb8c5410d6383f64d36/packages/zarvis` | `docs/arin/ARIN_IDENTITY_AND_COMPATIBILITY.md` | `verified` | PR #136 head `4a211f2f7701f9dcd9f0a01c9fbe43147455e38b` passed all required gates and merged as main `3a5dc16fa2eebdbd2d8d67da442c5a771bddf49a`. Inventory separates ARIN display identity from stable legacy machine identifiers, preserves retired `/api/jarvis/*` fail-closed semantics, and defines regression/deprecation requirements before rename. Documentation-only; no runtime dependency, source copy, alias authority, or actuation path. |
| `ARIN-MIG-0016` | ARIN identity compatibility regression tests | `cvsz/zasi@3a5dc16fa2eebdbd2d8d67da442c5a771bddf49a` | `tests/test_arin_identity_compatibility.py` | `integrating` | 22 regression tests covering all 8 JARVIS/ZARVIS stable machine identifiers from ARIN-MIG-0015: retired HTTP 410 routes, persona key, default fallback, OpenAPI spec, UI route provenance, container image name, acoustic profile, package keyword non-authority, and alias authority isolation. All 22 tests pass locally. Exact-head PR evidence required before promotion. |
